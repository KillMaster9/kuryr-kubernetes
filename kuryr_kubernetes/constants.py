...
K8S_API_NODES = K8S_API_BASE + '/nodes'
...
ICR_K8S_ANNOTATION_PREFIX = 'inspur.com/'
...
K8s_ANNOTATION_SERVICE_SUBNET = K8S_ANNOTATION_PREFIX + '-service-subnet'
K8s_ANNOTATION_LB_SERVICE_SUBNET = K8S_ANNOTATION_PREFIX + '-lb-service-subnet'
...
KURYR_PORT_NAME = 'iveth-pool-port'
...
K8s_ANNOTATION_VDC_ID = ICR_K8S_ANNOTATION_PREFIX + 'vdc-id'
...
K8s_ANNOTATION_PROJECT = 'cni.iveth.inspur.org/project-id'
