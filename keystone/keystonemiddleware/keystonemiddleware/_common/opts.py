...
CONF.register_opts(_OPTS, group=AUTHTOKEN_GROUP)
loading.register_auth_conf_options(cfg.CONF, AUTHTOKEN_GROUP)


auth_token_opts = [
    (AUTHTOKEN_GROUP, _OPTS + loading.get_auth_common_conf_options()),
]
...
def list_opts():
    ...
    return [(AUTHTOKEN_GROUP, copy.deepcopy(auth_token_opts))]
