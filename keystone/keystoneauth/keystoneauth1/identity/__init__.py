...
IamBaseIdentityPlugin = iam.BaseIdentityPlugin
"""See :class:`keystoneauth1.identity.iam.BaseIdentityPlugin`"""

IamPassword = iam.Password
"""See :class:`keystoneauth1.identity.iam.IamPassword`"""

IamAuthorizationCode = iam.AuthorizationCode
"""See :class:`keystoneauth1.identity.iam.AuthorizationCode`"""

IamRefreshToken = iam.RefreshToken
"""See :class:`keystoneauth1.identity.iam.RefreshToken`"""

IamToken = iam.Token
"""See :class:`keystoneauth1.identity.iam.Token`"""
...
__all__ = ('BaseIdentityPlugin',
           ...
           'V3MultiFactor',
           'IamBaseIdentityPlugin',
           'IamPassword',
           'IamAuthorizationCode',
           'IamRefreshToken',
           'IamToken')
